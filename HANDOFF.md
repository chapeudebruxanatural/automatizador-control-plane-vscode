...
| R-001 | crítico | **aberto e pior que o registrado** — o backup cobre **1 stack de 13**. O script arquiva *caminhos de arquivo*, não **volumes Docker**: `postgres_data`, `chatwoot_storage`, `n8n_redis`, `evolution_instances`, `nocodb_data`, `pgvector` e outros **não têm cópia nenhuma**. Inclui dois Postgres |
